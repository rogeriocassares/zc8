...
func init() {
	// vendor/transport/direction
	parser.RegisterParser("milesight/uplink", ParseMilesightLoraUplink)
...
func ParseMilesightLoraUplink(payload []byte) (*util.ParsedData, error) {
	dp := &util.ParsedData{
		Name:   "",
