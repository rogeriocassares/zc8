module github.com/rogeriocassares/zc8/services/transport/http-client

go 1.25.5

require (
	github.com/rogeriocassares/zc8/packages/go-config v0.0.0
	github.com/rogeriocassares/zc8/packages/go-transport v0.0.0
)
...
require (
	...
	github.com/rogeriocassares/zc8/packages/go-infra v0.0.0 // indirect
	github.com/rogeriocassares/zc8/packages/go-parser v0.0.0 // indirect
	github.com/rogeriocassares/zc8/packages/proto v0.0.0 // indirect
...
replace (
	...
	github.com/rogeriocassares/zc8/packages/go-transport => ../../../packages/go-transport
