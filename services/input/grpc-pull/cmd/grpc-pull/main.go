...
import (
	...
	grpcclient "github.com/rogeriocassares/zc8/services/input/grpc-pull/internal"
)
...
func main() {
	...
	log.Println("Starting gRPC Client Input Adapter...")
	...
	sinkCfg := integration.SinkConfigFromEnv("grpc-client")
	...
	log.Println("gRPC Client Input running. Press Ctrl+C to stop.")
	<-sigCh
